...
<div class="container">
    <div class="row">
        ...
        <div class="col left-container">
            <button class="btn" id="seleccionarProductosBtn"><i class="fas fa-box-open"></i> Productos</button>
            ...
            <button type="button" class="btn" id="confirmarVenta" style="margin-top: 15px ;display:none"><i class="fas fa-check"></i> Confirmar</button>
        ...
        <div class="col right-container">
            ...
            <button style="background: #007bff; color: white; border: white"type="button" class="btn" id="seleccionarClienteBtn">
            ...
            <button style="background: blueviolet; color: white; border: white" type="button" class="btn" id="realizarVenta"><i class="fas fa-cash-register"></i> Realizar Venta</button>
        </div>
    </div>
</div>
        ...
        <div class="modal-body">
            <div class="outer-wrapper">
                <div class="search-container">
                    <input type="text" id="searchProductosModal" onkeyup="filtrarProductosModal()" placeholder="Buscar productos...">
                </div>
                <div class="table-wrapper" style="max-height: 450px; overflow-y: scroll;">
                    <table class="table" id="tabla_productos">
                        ...
                        <tr>
                            ...
                            <td><button class="btn seleccionarProducto" data-id="<%= articulo.getIdArticulo()%>" data-producto="<%= articulo.getNomArticulo()%>" data-precio="<%= articulo.getPrecioVenta()%>" onclick="agregarProducto(this)"><i class="fas fa-plus"></i> Agregar</button></td>
                        </tr>
                        <%
                                }
                            } else {
...
<div class="modal" id="clientesModal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="search-container">
                <input type="text" id="searchClientesModal" onkeyup="filtrarClientesModal()" placeholder="Buscar clientes...">
            </div>
            <table class="table" id="tabla_clientes">
                ...
                <tr>
                    ...
                    <td><button style="background: #007bff; color: white; border: white" class="btn seleccionarCliente" data-id="<%= persona.getIdPersona()%>" data-cliente="<%= persona.getNomPersona()%>" onclick="seleccionarCliente(this)"><i class="fas fa-user-check"></i> Seleccionar</button></td>
                </tr>
                <%
                        }
                    } else {
...
<!-- Formulario para enviar datos de venta -->
...
<script>
    ...
    function filtrarProductos() {
        ...
        table = document.getElementById("detalle_venta");
    ...
    function filtrarProductosModal() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("searchProductosModal");
        filter = input.value.toUpperCase();
    ...
    function filtrarClientesModal() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("searchClientesModal");
        filter = input.value.toUpperCase();
        table = document.getElementById("tabla_clientes");
        tr = table.getElementsByTagName("tr");
        for (i = 0; i < tr.length; i++) {
            td = tr[i].getElementsByTagName("td")[1]; // Columna del nombre del cliente
            if (td) {
                txtValue = td.textContent || td.innerText;
                if (txtValue.toUpperCase().indexOf(filter) > -1) {
                    tr[i].style.display = "";
